...
export default async function CategoryDeatails({ params }: { params: { categoryId: string } }) {
  ...
  return (
    <>
      <div className="bg-background container mx-auto px-6 pt-23 md:pt-25 pb-10 min-h-screen">
        ...
        ) : (<h4 className="text-2xl text-muted-foreground absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 font-semibold text-center">No products found for this category.</h4>
        )}
      </div>
    </>
  )
